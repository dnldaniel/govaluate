...
func noopStageRight(left interface{}, right interface{}) (interface{}, error) {
	return right, nil
}
...
func equalStage(left interface{}, right interface{}) (interface{}, error) {
	return boolIface(reflect.DeepEqual(left, right)), nil
}
func notEqualStage(left interface{}, right interface{}) (interface{}, error) {
	return boolIface(!reflect.DeepEqual(left, right)), nil
}
func andStage(left interface{}, right interface{}) (interface{}, error) {
	return boolIface(left.(bool) && right.(bool)), nil
}
func setAndStage(left interface{}, right interface{}) (interface{}, error) {
	return "(" + left.(string) + " AND " + right.(string) + ")", nil
}
func setOrStage(left interface{}, right interface{}) (interface{}, error) {
	return "(" + left.(string) + " OR " + right.(string) + ")", nil
}
func setMinusStage(left interface{}, right interface{}) (interface{}, error) {
...
func bitwiseNotStage(left interface{}, right interface{}) (interface{}, error) {
...
func notRegexStage(left interface{}, right interface{}) (interface{}, error) {
...
func bitwiseOrStage(left interface{}, right interface{}) (interface{}, error) {
	return float64(int64(left.(float64)) | int64(right.(float64))), nil
}
func bitwiseAndStage(left interface{}, right interface{}) (interface{}, error) {
	return float64(int64(left.(float64)) & int64(right.(float64))), nil
}
func bitwiseXORStage(left interface{}, right interface{}) (interface{}, error) {
	return float64(int64(left.(float64)) ^ int64(right.(float64))), nil
}
func leftShiftStage(left interface{}, right interface{}) (interface{}, error) {
	return float64(uint64(left.(float64)) << uint64(right.(float64))), nil
}
func rightShiftStage(left interface{}, right interface{}) (interface{}, error) {
	return float64(uint64(left.(float64)) >> uint64(right.(float64))), nil
}
...
func makeAccessorStage(pair []string) EvaluationOperator {
	...
	return func(left interface{}, right interface{}) (ret interface{}, err error) {

		return nil, nil
	}
}

func separatorStage(left interface{}, right interface{}) (interface{}, error) {
